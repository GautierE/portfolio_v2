...
import { CourseTimelineHeading } from "./timeline-heading";
...
export const CourseTimeline = ({ data }: { data: CourseTimelineEntry[] }) => {
    ...
    return (
        <div className="w-full font-sans" ref={containerRef}>
            ...
            <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
                {data.map((item) => (
                    <CourseTimelineHeading key={item.title} entry={item} />
                ))}
                <div
                    style={{
                        height: height + "px",
